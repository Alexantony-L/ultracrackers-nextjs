...
const CartButton: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#4361EE] text-white shadow-lg shadow-[#4361EE]/25 transition hover:bg-[#1E3A8A] hover:shadow-xl active:scale-95 sm:bottom-8 sm:right-8"
    >
