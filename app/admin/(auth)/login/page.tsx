...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 p-6">
      ...
      <div className="pointer-events-none absolute -bottom-20 -right-20 h-72 w-72 rounded-full bg-red-600/20 blur-3xl" />
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8 shadow-2xl">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="
                ...
                py-3 pl-10 pr-3 text-sm text-white
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="
                w-full rounded-lg border border-slate-700 bg-slate-800
                py-3 pl-10 pr-10 text-sm text-white
                outline-none placeholder:text-slate-500
                transition-colors duration-150
                focus:border-[#f8ab13] focus:ring-2 focus:ring-[#f8ab13]/20
              "
          ...
          <button
            ...
            className="
              ...
              py-3 font-semibold text-slate-950
              shadow-md shadow-[#f8ab13]/20
